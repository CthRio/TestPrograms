 ...
 */
package com.ch01.testprogram.T7;
...
public class AccurateMath {
    ...
    static int EXP_INT_TABLE_MAX_INDEX = 750;
    /** Length of the array of integer exponentials. */
    static int EXP_INT_TABLE_LEN = EXP_INT_TABLE_MAX_INDEX * 2;
    /** Logarithm table length. */
    static int LN_MANT_LEN = 1024;
    /** Exponential fractions table length. */
    static int EXP_FRAC_TABLE_LEN = 1025; // 0, 1/1024, ... 1024/1024

    /** Error message. */
    private static String ZERO_DENOMINATOR_MSG = "Division by zero";
    /** Error message. */
    private static String OVERFLOW_MSG = "Overflow";
    /** StrictMath.log(Double.MAX_VALUE): {@value}. */
    private static double LOG_MAX_VALUE = StrictMath.log(Double.MAX_VALUE);
    ...
    private static long MASK_30BITS = -1L - (HEX_40000000 - 1); // 0xFFFFFFFFC0000000L;
    ...
    public static double SAFE_MIN = Double.MIN_NORMAL;
    /**
     * Private Constructor.
     */
    ...
    private static class Split {
        ...
        public static Split POSITIVE_INFINITY = new Split(Double.POSITIVE_INFINITY, 0);

        /** Split version of negative infinity. */
        public static Split NEGATIVE_INFINITY = new Split(Double.NEGATIVE_INFINITY, 0);
    ...
    public static long round(double x) {
        ...
        int shift = (52 - 1 + Double.MAX_EXPONENT) - biasedExp;
        if ((shift & -64) == 0) {
    ...
    public static int round(float x) {
        ...
        // Shift to get rid of bits past comma except first one: will need to
        // 1-shift to the right to end up with correct magnitude.
        int shift = (23 - 1 + Float.MAX_EXPONENT) - biasedExp;
        if ((shift & -32) == 0) {
    ...
    public static double IEEEremainder(double dividend, double divisor) {
        if (getExponent(dividend) == 1024 || getExponent(divisor) == 1024 || divisor == 0.0) {
            ...
            double n         = AccurateMath.rint(dividend / divisor);
            double remainder = Double.isInfinite(n) ? 0.0 : dividend - divisor * n;
